import csv
import os
#how do we wrap the images with the data-lightbox stuff
...
<div class="athlete">
<figure> 
<a href ="../images/profiles/{profile_pic}" target="" data-lightbox="athlete" data-title="{name} Profile">
...
"""
   ...
   <footer>
                    ...
                    Follow us on Instagram <a href = "https://www.instagram.com/a2skylinexc/" aria-label="Instagram"><i class="fa-brands fa-instagram"></i>  </a> 
                     ...
                     <script src="../dist/js/lb.js"></script>
...
def select_random_photos(folder_path, num_photos=5):  # Set default to 5 photos
    # List all files in the folder
    all_files = os.listdir(folder_path)
    # Filter out non-image files (assuming .jpg, .png, etc.)
